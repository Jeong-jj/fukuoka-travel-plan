...
export default function App() {
  ...
  return <main className="site-shell"><div className="ambient ambient-a"/><div className="ambient ambient-b"/><div className="wrap">
    <header className="hero"><div className="eyebrow">FUKUOKA TRIP PLANNER · <strong>BETA 1.5.1</strong></div><div className="hero-row"><div><h1>후쿠오카<br className="mobile-break"/> 4박 5일</h1><p>2026.09.18 — 09.22 · 남자 둘 · 도시 / 역사 / 축제 / 쇼핑 / 먹거리 / 술</p></div><div className="stamp">九州<br/><span>FUKUOKA</span></div></div>
    ...
    </section><footer>FUKUOKA TRIP PLANNER · BETA 1.5.1 · 일정과 교통 시각은 여행 당일 공식 안내와 Google Maps로 재확인</footer>
  </div></main>;
}
