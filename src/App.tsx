...
const food: CardRow[] = [
  ...
  ['우메가에모치', '다자이후 산도에서 간식'],
  ['시치린야', '하루요시 1초메 · Google Maps에 저장한 먹거리 후보', [['Google Maps', 'https://maps.app.goo.gl/suXqMW8KbTK43iQ88?g_st=ic']]],
  ['설화(유키하나)', '하루요시 3초메 · 파노라마 스퀘어 하카타 1층', [['Google Maps', 'https://maps.app.goo.gl/QthTzh2mijSMqVjr8?g_st=ic']]],
  ['오뎅바 후보', '나다이오뎅 야스베 · 니시나카스 / 하츠유키 · 다이묘', [
    ['야스베 지도', 'https://maps.app.goo.gl/tUSkHgRwiMJo4mBcA?g_st=ic'],
    ['하츠유키 지도', 'https://maps.app.goo.gl/pP8XNsdgj8DSPv1A9?g_st=ic'],
  ]],
];
...
export default function App() {
  ...
  return <main className="site-shell"><div className="ambient ambient-a"/><div className="ambient ambient-b"/><div className="wrap">
    <header className="hero"><div className="eyebrow">FUKUOKA TRIP PLANNER · <strong>BETA 1.4.2</strong></div><div className="hero-row"><div><h1>후쿠오카<br className="mobile-break"/> 4박 5일</h1><p>2026.09.18 — 09.22 · 남자 둘 · 도시 / 역사 / 축제 / 쇼핑 / 먹거리 / 술</p></div><div className="stamp">九州<br/><span>FUKUOKA</span></div></div>
    ...
    </section><footer>FUKUOKA TRIP PLANNER · BETA 1.4.2 · 일정과 교통 시각은 여행 당일 공식 안내와 Google Maps로 재확인</footer>
  </div></main>;
}
